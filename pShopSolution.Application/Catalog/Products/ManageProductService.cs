...
using pShopSolution.Utitlties.Contants;
...
namespace pShopSolution.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new pShopException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new pShopException($"Cannot find a product with id: {productId}");
        ...
        public async Task<int> RemoveImage(int imageId)
        {
            ...
            if (productImage == null)
                throw new pShopException($"Cannot find an image with id {imageId}");
