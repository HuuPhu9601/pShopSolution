...
namespace pShopSolution.ViewModels.System.Users
{
    public class RegisterRequestvalidator : AbstractValidator<RegisterRequest>
    {
        ...
        {
            RuleFor(x => x.FirstName).NotEmpty().WithMessage("First name is required").MaximumLength(200).WithMessage("First name can not over 200 character");
            ...
            RuleFor(x => x.Dob).GreaterThan(DateTime.Now.AddYears(-100)).WithMessage("Birthday connot greaterthan 100 years");
